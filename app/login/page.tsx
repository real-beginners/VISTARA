...
import { getProfile, isAuthConfigured, signIn } from "@/lib/auth";
...
export default function LoginPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setError("");
    if (!identifier.trim() || !password) return setError("Enter your email and password to continue.");
    setLoading(true);
    try {
